...
<body>
    ...
    <form class="container" method="post">
        ...
        <div class="form-group col-md-12">
            ...
            <input type="text" class="form-control" name="montant" placeholder="Montant de financement" required>
        </div>
        <div class="form-group col-md-12">
    ...
    <?php
        $x = 0;
        if (isset($_POST["button"]) && !is_numeric($_POST["montant"])) {
            echo '<script> alert("Montant doit être un nombre réel!") </script>';
            $x = 1;
        }
